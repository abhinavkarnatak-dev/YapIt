      ...
      <main className="max-w-3xl mx-auto px-6 py-12 lg:py-20 space-y-12">
        ...
        <div className="space-y-10 text-on-surface-variant leading-relaxed text-sm md:text-base">
          ...
          <section className="space-y-4">
            ...
            <p className='text-sm md:text-base'>To use the service, you must:</p>
          ...
          <section className="space-y-4">
            ...
            <p className='text-sm md:text-base'>Your private communications will not be used for advertising purposes.</p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className='text-sm md:text-base'>The service may occasionally be unavailable due to:</p>
          ...
          <section className="space-y-4">
            ...
            <p className='text-sm md:text-base'>YapIt is provided "as is" and "as available."</p>
            ...
            <p className='text-sm md:text-base'>Your use of the service is at your own risk.</p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className='text-sm md:text-base'>We may suspend or terminate your access to YapIt if:</p>
            ...
            <p className='text-sm md:text-base'>You may stop using the service at any time.</p>
          </section>
